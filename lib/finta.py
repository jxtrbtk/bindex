...
class TA:
    ...
    @classmethod
    def TMF(cls, ohlcv: DataFrame, period: int = 21, adjust: bool = True) -> Series:
...
#         EMA = pd.Series(
#             ohlcv["volume"].ewm(ignore_na=False, span=period, adjust=adjust).mean(),
#             name="EMA",
#         )
        
#         TMF = (EMA * ohlcv["range"]) / EMA 
#         TMF = 
